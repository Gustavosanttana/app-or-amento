 ...
 class Bd {
    ...
    getProximoId() {
     ...
     recuperarTodosRegistros() {
        ...
        //Desta forma podemos recuperar todas as despesas de LocalStorage
        for(let i = 1; i<= id; i++) {
            //recuperar a depesa
            let despesa = JSON.parse(localStorage.getItem(i))

            //Se existe a possibilidade de haver indice que foram pulados/removidos
 ...
 function cadastrarDespensa() {
    ...
    if(despesa.validarDados()) {  
         bd.gravar(despesa)
          ...
          //dialog de sucesso
            document.getElementById('modal_titulo').innerHTML = 'Rgistro iserido com sucesso'
    ...
    if(btn.remover(id) == localStorage.removeItem(id)){
        document.getElementById('modal_titulo').innerHTML = 'Erro na inclusão do registro'
        document.getElementById('modal_titulo_div').className = 'modal-header text-danger'
        document.getElementById('modal_conteudo').innerHTML = 'Erro de gravação, verifique se todos os campos foram preenchidos corretamente'
        document.getElementById('modal_btn').innerHTML = 'Voltar  e corrigir'
